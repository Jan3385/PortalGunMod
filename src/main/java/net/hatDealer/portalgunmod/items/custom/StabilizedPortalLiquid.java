...
public class StabilizedPortalLiquid extends Item {

    public StabilizedPortalLiquid(Properties pProperties) {
        super(pProperties);
    }
    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.stable.potion").withStyle(ChatFormatting.DARK_GRAY));
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            ...
            StablePortalLiquidProjectile projectile = new StablePortalLiquidProjectile(pLevel, pPlayer);
